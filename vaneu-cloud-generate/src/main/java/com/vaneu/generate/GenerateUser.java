...
public class GenerateUser {
	...
	static String tableNames[] = { "t_user" }; // 需要生成代码的表名
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://127.0.0.1:3306/vaneu-cloud-user?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Hongkong");
